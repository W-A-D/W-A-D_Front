...
function MypageMyQ() {
    ...
    const [sortOrder, setSortOrder] = useState('latest'); // 'latest' 또는 'popular'를 상태로 관리
    ...
    const sortedPosts = [...posts].sort((a, b) => {
        if (sortOrder === 'latest') {
            return new Date(b.daysAgo) - new Date(a.daysAgo); // 최근순
    ...
    return (
        <div className='MypageMyQ-container'>
            <div className='MypageMyQ-blueheaderline' />
            <div className='MypageMyQ-maincontainer'>
                <div className='MypageMyQ-widget'>
                    <div className='MypageMyQ-profile'>
                        <div className='MypageMyQ-profileimage'>
                            <img src={profileImage} alt="" />
                        </div>
                        <div className='MypageMyQEdit' onClick={openeditProfileModal}>
                            <img src={edit} alt="" />
                        </div>
                    </div>
                    <div className='MypageMyQ-userInfo'>
                        <div className='MypageMyQ-user'>
                            <div className='MypageMyQ-userName'>{userName}</div>
                            <div className='MypageMyQ-sir'>님</div>
                        </div>
                    </div>
                    <div className='MypageMyQ-userQnA'>
                        <div className='MypageMyQ-userQ' onClick={handleMypageMyQClick}>작성질문</div>
                        <div className='MypageMyQ-userA' onClick={handleMypageMyAClick}>작성답변</div>
                    </div>
                    <div className='MypageMyQ-unregister' onClick={openunregisterModal}>회원탈퇴</div>
                </div>
                <div className='MypageMyQ0-postBigContainer'>
                    <div className='MypageMyQ-postcontainer'>
                        <div className='MypageMyQ-postcontainerHeader'>
                            작성질문
                        </div>
                        <div className='MypageMyQ-postFilter'>
                            <div
                                className={`MypageMyQ-LikeFilter ${sortOrder === 'popular' ? 'active' : ''}`}
                                onClick={() => handleSortOrder('popular')}
                            >
                                -인기순
                            </div>
                            <div
                                className={`MypageMyQ-LatestFilter ${sortOrder === 'latest' ? 'active' : ''}`}
                                onClick={() => handleSortOrder('latest')}
                            >
                                -최근순
                            </div>
                        </div>
                        <div className='MypageMyQ-postList'>
                            {currentPosts.map((post, index) => (
                                <div key={index} className='MypageMyQ-postbox'>
                                    <div className='MypageMyQ-Q-Mark'>Q</div>
                                    <div className='MypageMyQ-Post'>
                                        <div className='MypageMyQ-postInfo'>
                                            <div className='MypageMyQ-postheader'>
                                                <div className='MypageMyQ-postCategory'>
                                                    {post.category}
                                                </div>
                                                <div className='MypageMyQ-postTitle'>
                                                    {post.title}
                                                </div>
                                            </div>
                                            <div className='MypageMyQ-days-ago'>
                                                {post.daysAgo}
                                            </div>
                                        </div>

                                        <div className='MypageMyQ-postSummary'>
                                            {post.summary}
                                        </div>
                                        <div className='MypageMyQ-additionalInfo'>
                                            <div className='MypageMyQ-postLike'>
                                                <div className='MypageMyQ-postLikeIcon'>
                                                    <img src={likeIcon} alt="" />
                                                </div>
                                                <div className='MypageMyQ-postLikeText'>
                                                    {post.likes}
                                                </div>
                                            </div>
                                            <div className='MypageMyQ-postComment'>
                                                <div className='MypageMyQ-postCommentIcon'>
                                                    <img src={commentIcon} alt="" />
                                                </div>
                                                <div className='MypageMyQ-postCommentText'>
                                                    {post.comments}
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className='MypageMyQ-pagination'>
